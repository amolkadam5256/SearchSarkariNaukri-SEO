# Section 38 - Police / CAPF

## Purpose

Help users find police, CAPF and state security recruitment.

## Recommended UI

- Heading: `Police And CAPF Jobs`
- Description: `Browse police constable, SI, CAPF, state police and related recruitment updates.`
- Include Maharashtra Police as a priority link.
...
Do not fabricate physical eligibility or exam dates.

## Performance And Accessibility

Use accessible status tags and clear labels.
