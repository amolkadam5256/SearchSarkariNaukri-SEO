...
Help users browse by recruitment type and work category.

## Recommended UI

- Heading: `Explore Jobs By Type`
- Description: `Browse active recruitment by job type, appointment style and career path.`
- Suggested groups: Permanent, Contract, Apprentice, Internship, Walk-in, Teaching, Technical, Non-technical, Police, Railway.

## SEO Keywords

- government job type
- apprentice government jobs
- contract government jobs
- teaching government jobs
- technical Sarkari Naukri

## Links

Link only to live pages such as `/jobs?type=apprentice` if canonical policy allows, or cleaner landing pages like `/apprentice-jobs`.

## Rules

Do not expose parameter URLs as SEO targets unless canonicalized correctly.

## Performance And Accessibility

Use chips or compact grouped lists. No heavy filter script needed.
