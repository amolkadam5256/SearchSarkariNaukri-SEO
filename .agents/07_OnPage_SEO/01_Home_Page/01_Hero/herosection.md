...
**Government Job Information Platform**

or:

**Maharashtra & India Government Job Updates**
...
# 47. Responsive Banner Implementation Prompt

Use this exact responsive prompt when implementing or reviewing the Hero
banner:

```text
Create a responsive homepage Hero banner using the approved 1364 px x
500 px desktop design as the visual reference.

The Hero must keep the same dark-blue/orange visual direction, centered
content hierarchy, live HTML H1, paragraph, search form, CTA links,
trust line, and benefit strip.

Desktop:
- Use the 1364 px x 500 px composition as the reference size.
- Keep the Hero visually balanced inside a full-width section.
- Center the content container.
- Preserve readable spacing between the H1, paragraph, search bar,
  CTA row, trust line, and benefit strip.

Tablet:
- Scale the layout proportionally.
- Keep the search bar usable and avoid cramped CTA buttons.
- Allow the CTA row to wrap if needed.
- Keep background artwork decorative and subordinate to the text.

Mobile:
- Do not force the 1364 px desktop canvas into the viewport.
- Stack content vertically in this order: ticker, status badge, H1,
  paragraph, search input, Search Government Jobs button, Browse
  Maharashtra Jobs link, Check Eligibility link, trust line, benefit
  strip.
- Use responsive typography so the H1 remains prominent but does not
  consume the entire first viewport.
- Make the search input and primary CTA full-width.
- Keep all tap targets comfortable.
- Prevent horizontal scrolling at 320px, 360px, 375px, 390px and 414px.

The final implementation must use real HTML/CSS for text and controls.
Do not rely on text baked into the banner image for SEO,
accessibility, or interaction.
```

---

# 48. CTA Touch Targets
...
# 51. Performance Rule for Ticker
...
# 53. Do Not Put Current Job Titles in H1
...
# 54. Do Not Put District Name in H1
...
# 55. Do Not Put Qualification in H1
...
# 56. Do Not Put Department in H1
...
# 58. Final Visual Design Direction
...
# 59. Important: Orange H1 Keyword
...
# 63. Hero Background CSS Principle
...
# 66. No Unnecessary Third-Party Scripts
...
# 71. Regression Test --- Accessibility
...
# 72. Regression Test --- Performance
...
# 74. Final Approved Hero Content Table
...
# 76. What Developers Must NOT Do
...
# 78. Final Developer Instruction
