...
Support city-level job discovery for major Indian and Maharashtra cities.

## Recommended UI

- Heading: `City-Wise Sarkari Naukri`
- Description: `Find government job updates by city, including local, state and central recruitment opportunities.`

## SEO Keywords

- city wise Sarkari Naukri
...
Use live city pages only: Pune, Mumbai, Nagpur, Nashik, Bangalore, Delhi, Chennai, Kolkata, Jaipur, Lucknow, Hyderabad, Ahmedabad.

## Rules

No city link should return 404. Thin city pages should be improved or noindexed.

## Performance And Accessibility

Use grouped links, not a heavy map.
