# Section 51 - Exam Preparation Hub

## Purpose

Connect recruitment discovery to study resources.

## Recommended UI

- Heading: `Exam Preparation Hub`
- Description: `Prepare for UPSC, MPSC, SSC, railway, banking, police and other government exams with daily assessment and study material.`

## SEO Keywords

- government exam preparation
- UPSC MPSC SSC preparation
- railway banking exam preparation
- Sarkari exam study material
...
Do not load full study modules on homepage.

## Performance And Accessibility

Link out to focused pages.
