# Crawled Currently Not Indexed URL Brief 015

## URL
`https://www.searchsarkarinaukri.com/mbbs-medical-jobs-in-gujarat`
...
## Page Type
Qualification/location landing page
...
## Primary Action
`IMPROVE_LANDING_PAGE_OR_NOINDEX_IF_THIN`
...
- Add 10-15 FAQs specific to `mbbs medical jobs in gujarat`.
